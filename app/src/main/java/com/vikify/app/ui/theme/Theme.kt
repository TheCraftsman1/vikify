package com.vikify.app.ui.theme
...
private val CoolTokens = VikifyColors(
    ...
    brandPrimary = BrandCyan,
    brandSecondary = BrandPurple,
    accent = Color(0xFF00D4FF),  // Brighter cyan accent
    
    // More distinct blueish-dark background
    surfaceBackground = Color(0xFF0D1117),  // GitHub-style dark with blue tint
    surfaceCard = Color(0xFF161B22),        // Bluer card color
    surfaceSheet = Color(0xFF1C2128),       // Elevated sheet
    surface = Color(0xFF161B22),
    surfaceElevated = Color(0xFF21262D),
    background = Color(0xFF0D1117),
    
    textPrimary = NeutralWhite,
    textSecondary = Color(0xFF8B949E),      // Bluer gray for COOL
    ...
    // Cyan-tinted glass
    glassBackground = Color(0xFF0D1117).copy(alpha = 0.8f),
    glassBorder = Color(0xFF00D4FF).copy(alpha = 0.15f),  // Cyan border tint
    
    border = Color(0xFF30363D),             // Bluer border
    divider = Color(0xFF21262D),
    
    error = StatusError,
    success = StatusSuccess,
    
    glow = Color(0xFF00D4FF),               // Bright cyan glow
    ...
    lyricsInactive = NeutralWhite.copy(alpha = 0.4f),
    lyricsPassed = NeutralWhite.copy(alpha = 0.25f),
    lyricsHighlight = Color(0xFF00D4FF).copy(alpha = 0.25f),
    
    // Player - Cyan accents
    playerSurface = Color(0xFF161B22),
    progressTrack = Color(0xFF30363D),
    progressFill = Color(0xFF00D4FF)
)
