...
// ═══════════════════════════════════════════════════════════════════════════════
// NEW ENHANCEMENTS FOR GLASS UI
// ═══════════════════════════════════════════════════════════════════════════════

@Composable
fun Modifier.premiumCardShadow(
    isDark: Boolean,
    accentColor: Color = VikifyTheme.colors.accent
): Modifier {
    return this.shadow(
        elevation = 16.dp,
        shape = androidx.compose.foundation.shape.RoundedCornerShape(16.dp),
        spotColor = if (isDark) accentColor.copy(alpha = 0.4f) else Color.Black.copy(alpha = 0.2f),
        ambientColor = if (isDark) accentColor.copy(alpha = 0.1f) else Color.Black.copy(alpha = 0.05f)
    )
}
...
fun PlayingEqualizerBars(
    ...
    color: Color = VikifyTheme.colors.accent
) {
    ...
    Row(
        ...
        Box(modifier = Modifier.width(4.dp).fillMaxHeight(bar1).background(color, androidx.compose.foundation.shape.RoundedCornerShape(topStart = 2.dp, topEnd = 2.dp)))
        Box(modifier = Modifier.width(4.dp).fillMaxHeight(bar2).background(color, androidx.compose.foundation.shape.RoundedCornerShape(topStart = 2.dp, topEnd = 2.dp)))
        Box(modifier = Modifier.width(4.dp).fillMaxHeight(bar3).background(color, androidx.compose.foundation.shape.RoundedCornerShape(topStart = 2.dp, topEnd = 2.dp)))
    }
}
