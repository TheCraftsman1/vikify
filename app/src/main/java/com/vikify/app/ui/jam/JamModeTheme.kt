...
object JamModeTheme {
     ...
     */
    fun getColors(style: JamModeThemeStyle, dynamicColor: Color? = null): JamModeColors {
        return when (style) {
            JamModeThemeStyle.CYBERPUNK -> CyberpunkJamColors
            JamModeThemeStyle.LOFI -> LofiJamColors
            JamModeThemeStyle.AUTO -> {
