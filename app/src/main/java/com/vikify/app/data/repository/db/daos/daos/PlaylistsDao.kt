package com.vikify.app.data.repository.db.daos.daos
...
import com.vikify.app.core.extensions.reversed
...
interface PlaylistsDao {
    ...
    fun deletePlaylistByBrowseId(browseId: String)
    ...
    // =========================================================================
    // SPOTIFY PLAYLIST PERSISTENCE
    // =========================================================================

    /**
     * Get all Spotify-imported playlists
     */
    @Transaction
    @Query("""
        SELECT 
        ...
        ORDER BY p.name COLLATE NOCASE ASC
    """)
    fun onlinePlaylists(): Flow<List<Playlist>>
}
