...
import com.vikify.app.data.repository.db.MusicDatabase.Companion.MUSIC_DATABASE_VERSION
...
import com.vikify.app.data.repository.db.entities.entities.PlayCountEntity
import com.vikify.app.data.repository.db.entities.entities.PlayEvent
import com.vikify.app.data.repository.db.entities.entities.PlaylistEntity
import com.vikify.app.data.repository.db.entities.entities.PlaylistEntity.Companion.generatePlaylistId
import com.vikify.app.data.repository.db.entities.entities.PlaylistSongMap
import com.vikify.app.data.repository.db.entities.entities.PlaylistSongMapPreview
...
import com.vikify.app.data.repository.db.entities.entities.SortedSongAlbumMap
import com.vikify.app.data.repository.db.entities.entities.SortedSongArtistMap
...
@Database(
    entities = [
        ...
        PlayEvent::class,
        SpotifyPlaylistCacheEntity::class,
        SpotifyPlaylistTrackMap::class
    ],
    views = [
    ...
    autoMigrations = [
        ...
        AutoMigration(from = 22, to = 23), // Hybrid-Offline enhancements
        AutoMigration(from = 23, to = 24), // Spotify playlist cache for offline
    ]
)
