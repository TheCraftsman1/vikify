package com.vikify.app.data.repository.db
...
import com.vikify.app.data.repository.db.daos.daos.AlbumsDao
import com.vikify.app.data.repository.db.daos.daos.ArtistsDao
import com.vikify.app.data.repository.db.daos.daos.PlaylistsDao
import com.vikify.app.data.repository.db.daos.daos.QueueDao
import com.vikify.app.data.repository.db.daos.daos.SongsDao
import com.vikify.app.data.repository.db.daos.daos.HistoryDao
import com.vikify.app.data.repository.db.entities.entities.AlbumArtistMap
import com.vikify.app.data.repository.db.entities.entities.AlbumEntity
import com.vikify.app.data.repository.db.entities.entities.ArtistEntity
import com.vikify.app.data.repository.db.entities.entities.Event
import com.vikify.app.data.repository.db.entities.entities.EventWithSong
import com.vikify.app.data.repository.db.entities.entities.FormatEntity
import com.vikify.app.data.repository.db.entities.entities.GenreEntity
import com.vikify.app.data.repository.db.entities.entities.LyricsEntity
import com.vikify.app.data.repository.db.entities.entities.QueueEntity
import com.vikify.app.data.repository.db.entities.entities.QueueSongMap
import com.vikify.app.data.repository.db.entities.entities.RecentActivityEntity
import com.vikify.app.data.repository.db.entities.entities.RecentActivityType
import com.vikify.app.data.repository.db.entities.entities.RelatedSongMap
import com.vikify.app.data.repository.db.entities.entities.SearchHistory
import com.vikify.app.data.repository.db.entities.entities.Song
import com.vikify.app.data.repository.db.entities.entities.SongAlbumMap
import com.vikify.app.data.repository.db.entities.entities.SongArtistMap
import com.vikify.app.data.repository.db.entities.entities.SongEntity
import com.vikify.app.data.repository.db.entities.entities.SongGenreMap
import com.vikify.app.data.repository.db.entities.entities.SpotifyPlaylistCacheEntity
import com.vikify.app.data.repository.db.entities.entities.SpotifyPlaylistTrackMap
import com.vikify.app.core.extensions.toSQLiteQuery
...
AND NOT EXISTS (
    ...
    // === SPOTIFY PLAYLIST CACHING FOR OFFLINE ===
    
    /**
     * Insert or update a cached Spotify playlist
     */
    @Upsert
    fun upsertSpotifyPlaylistCache(playlist: SpotifyPlaylistCacheEntity)
    
    /**
     * Get all cached Spotify playlists
     */
    @Query("SELECT * FROM spotify_playlist_cache ORDER BY name ASC")
    fun getCachedSpotifyPlaylists(): Flow<List<SpotifyPlaylistCacheEntity>>
    
    /**
     * Get a single cached Spotify playlist by ID
     */
    @Query("SELECT * FROM spotify_playlist_cache WHERE spotifyId = :playlistId")
    fun getCachedSpotifyPlaylist(playlistId: String): Flow<SpotifyPlaylistCacheEntity?>
    
    /**
     * Delete a cached Spotify playlist
     */
    @Query("DELETE FROM spotify_playlist_cache WHERE spotifyId = :playlistId")
    fun deleteCachedSpotifyPlaylist(playlistId: String)
    
    /**
     * Insert a playlist-track mapping
     */
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    fun insertSpotifyPlaylistTrackMap(map: SpotifyPlaylistTrackMap)
    
    /**
     * Delete all track mappings for a playlist
     */
    @Query("DELETE FROM spotify_playlist_track_map WHERE playlistId = :playlistId")
    fun deleteSpotifyPlaylistTrackMaps(playlistId: String)
    
    /**
     * Get all Spotify track IDs for a playlist (ordered by position)
     */
    @Query("SELECT spotifyTrackId FROM spotify_playlist_track_map WHERE playlistId = :playlistId ORDER BY position ASC")
    fun getSpotifyPlaylistTrackIds(playlistId: String): Flow<List<String>>
    
    /**
     * Get cached songs for a Spotify playlist (joins track map with songs)
     */
    @Transaction
    @Query("""
        SELECT song.* FROM song
        INNER JOIN spotify_playlist_track_map map ON song.spotifyId = map.spotifyTrackId
        WHERE map.playlistId = :playlistId
        ORDER BY map.position ASC
    """)
    fun getCachedSpotifyPlaylistSongs(playlistId: String): Flow<List<SongEntity>>
}
