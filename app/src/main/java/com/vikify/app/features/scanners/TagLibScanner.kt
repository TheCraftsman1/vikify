...
import com.vikify.app.core.constants.DEBUG_SAVE_OUTPUT
import com.vikify.app.core.constants.EXTRACTOR_DEBUG
...
import com.vikify.app.core.utils.EXTRACTOR_TAG
    ...
    override suspend fun getAllMetadataFromFile(file: File): SongTempData {
        ...
        ParcelFileDescriptor.open(file, ParcelFileDescriptor.MODE_READ_ONLY).use { fd ->
            ...
            val audioProperties = TagLib.getAudioProperties(fd.dup().detachFd())
                ?: throw IllegalStateException("Failed to read audio properties from: ${file.absolutePath}")
            ...
            val metadata = TagLib.getMetadata(fd = fd.dup().detachFd(), readPictures = false)
                ?: throw IllegalStateException("Failed to read metadata from: ${file.absolutePath}")
