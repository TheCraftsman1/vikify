...
import com.vikify.app.core.constants.MediaSessionConstants
...
import com.vikify.app.core.extensions.toggleRepeatMode
import com.vikify.app.core.extensions.toggleShuffleMode
...
class MediaLibrarySessionCallback @Inject constructor(
    ...
    private fun com.vikify.app.data.repository.models.MediaMetadata.toMediaItem(isPlayable: Boolean = true, isBrowsable: Boolean = false) = MediaItem.Builder()
        .setMediaId(id)
        .setUri(id)
