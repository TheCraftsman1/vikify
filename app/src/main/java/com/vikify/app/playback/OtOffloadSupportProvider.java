 ...
 */
@UnstableApi
public final class OtOffloadSupportProvider implements DefaultAudioSink.AudioOffloadSupportProvider {
    ...
    /** Creates an instance. */
    public OtOffloadSupportProvider() {
        this(/* context= */ null);
    }
     ...
     */
    public OtOffloadSupportProvider(@Nullable Context context) {
...
//            boolean isGaplessSupported = SDK_INT > 32 && isGaplessAllowed
