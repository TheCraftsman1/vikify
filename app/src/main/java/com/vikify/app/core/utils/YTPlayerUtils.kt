...
import com.vikify.app.core.utils.YTPlayerUtils.MAIN_CLIENT
import com.vikify.app.core.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.vikify.app.core.utils.YTPlayerUtils.validateStatus
import com.vikify.app.features.potoken.PoTokenGenerator
import com.vikify.app.features.potoken.PoTokenResult
...
object YTPlayerUtils {
    ...
    // NETWORK FIX: Add timeouts to prevent infinite hangs
     ...
     * IOS client removed - causes 403 errors after 30 seconds due to API changes.
     */
    private val STREAM_FALLBACK_CLIENTS: Array<YouTubeClient> = arrayOf(
        WEB_REMIX,
        // IOS removed - recent API changes produce error 403 after 30 seconds
    )
