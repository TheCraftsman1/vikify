...
import com.vikify.app.db.entities.SpotifyPlaylistCacheEntity
import com.vikify.app.db.entities.SpotifyPlaylistTrackMap
                    ...
                    if (items != null) {
                        for (i in 0 until items.length()) {
                            ...
                            database.upsertSpotifyPlaylistCache(
                                com.vikify.app.db.entities.SpotifyPlaylistCacheEntity(
                                    spotifyId = id,
                                    name = name,
                                    imageUrl = imageUrl,
                                    trackCount = count,
                    ...
                    try {
                        ...
                        tracksToCache.forEachIndexed { index, track ->
                            ...
                            database.insertSpotifyPlaylistTrackMap(
                                com.vikify.app.db.entities.SpotifyPlaylistTrackMap(
