...
import com.vikify.app.constants.MediaSessionConstants
...
import com.vikify.app.extensions.toggleRepeatMode
import com.vikify.app.extensions.toggleShuffleMode
...
class MediaLibrarySessionCallback @Inject constructor(
    ...
    private fun com.vikify.app.models.MediaMetadata.toMediaItem(isPlayable: Boolean = true, isBrowsable: Boolean = false) = MediaItem.Builder()
        .setMediaId(id)
        .setUri(id)
